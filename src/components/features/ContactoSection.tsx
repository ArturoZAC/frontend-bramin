      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ¿Tienes alguna pregunta o proyecto en mente? Nos encantaría escucharte. Completa el
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+51 948 339 595</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Calle Mercaderes - Arequipa - Perú</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Redes sociales */}
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">Síguenos</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <h4 className="font-semibold text-gray-900 mb-2">¿Prefieres llamarnos?</h4>
