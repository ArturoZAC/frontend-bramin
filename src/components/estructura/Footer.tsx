...
export default function Footer() {
  ...
  const servicios = [
    { nombre: "Ingeniería y Construcción", link: "#servicios" },
    { nombre: "Gestión de Proyectos", link: "#servicios" },
    { nombre: "Consultoría en Minería", link: "#servicios" },
    { nombre: "Topografía y Geomática", link: "#servicios" },
    { nombre: "Diseño y Planificación", link: "#servicios" },
    { nombre: "Gestión Ambiental", link: "#servicios" },
  ];
        ...
        <Container className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <section className="w-full lg:col-span-1">
            ...
            <p className="text-blue-100 text-sm leading-relaxed mb-6">
              Desarrollamos soluciones constructivas modernas que impulsan tu proyecto hacia el
              futuro.
            </p>
